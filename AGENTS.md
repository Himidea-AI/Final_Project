...
- **Jira 프로젝트 키**: `BAT98`
- **브랜치 네이밍**: `BAT98-<이슈번호>-<담당영역>-<설명>` (예: `BAT98-12-agents-add-supervisor-retry`)
- **커밋 메시지**: Jira 이슈 키로 시작 (예: `BAT98-12 추가: 경쟁분석 노드 재시도 로직`)
- **PR 제목**: Jira 이슈 키 포함 (예: `BAT98-12 추가: 경쟁분석 노드 재시도 로직`)
