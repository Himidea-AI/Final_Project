...
def pretrain(config: dict | None = None) -> Path:
    ...
    _save_scalers(feat_scaler, tgt_scaler, save_path.parent / "pretrain_tcn_scalers.pkl")
...
def finetune(config: dict | None = None) -> Path:
    ...
    # 스케일러 저장
    _save_scalers(feat_scaler, tgt_scaler, save_path.parent / "finetune_tcn_scalers.pkl")
