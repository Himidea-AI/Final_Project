/**
 * 서울특별시 25개 구 + 행정동 매핑 데이터
 *
 * 데이터 출처:
 * - 마포구: data/geo/mapo_dong.geojson (BASE_DATE 20250630, 검증됨, 16개 행정동)
 * - 기타 24개 구: 행정안전부 행정동 기준 (시연용 mock)
 *
 * 주의:
 * - 마포구 MVP 단계라 기타 구는 시연 목적의 정적 데이터.
 * - 실제 서비스 시 backend의 행정동 API로 교체 필요.
 */
...
export const SEOUL_REGIONS: Record<string, string[]> = {
  ...
  성동구: [
    ...
    "성수1가1동", "성수1가2동", "성수2가1동", "성수2가3동", "송정동", "용답동",
  ],
  광진구: [
  ...
  // ✅ 마포구: data/geo/mapo_dong.geojson 검증 완료 (16개 행정동)
  마포구: [
  ...
  강서구: [
    ...
    "우장산동", "가양1동", "가양2동", "가양3동", "발산1동", "공항동",
    "방화1동", "방화2동", "방화3동",
  ],
  구로구: [
    "신도림동", "구로1동", "구로2동", "구로3동", "구로4동", "구로5동",
    "가리봉동", "수궁동", "고척1동", "고척2동", "개봉1동", "개봉2동", "개봉3동",
    "오류1동", "오류2동",
  ],
  금천구: [
  ...
  관악구: [
    "보라매동", "청림동", "성현동", "행운동", "낙성대동", "청룡동", "은천동",
    "중앙동", "인헌동", "남현동", "서원동", "신원동", "서림동",
  ...
  강남구: [
    ...
    "역삼1동", "역삼2동", "도곡1동", "도곡2동",
    "개포1동", "개포2동", "개포4동",
    "세곡동", "일원본동", "일원1동", "일원2동", "수서동",
  ],
  송파구: [
    "풍납1동", "풍납2동", "거여1동", "거여2동", "마천1동", "마천2동",
    "방이1동", "방이2동", "오륜동", "오금동", "송파1동", "송파2동",
    "석촌동", "삼전동", "가락본동", "가락1동", "가락2동",
    "문정1동", "문정2동", "장지동", "위례동",
    "잠실본동", "잠실2동", "잠실3동", "잠실4동", "잠실6동", "잠실7동",
  ],
  강동구: [
