      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl p-8">
          ...
          <div className="flex flex-col gap-3">
            <button
              onClick={() => nav('/joinus')}
              className="w-full py-3 rounded-xl text-xs font-bold text-muted-foreground border border-border hover:border-primary/50 hover:text-foreground transition-colors"
            >
              아직 계정이 없으신가요? 회원가입
            </button>
            <button
