...
|------|------|
| **MAPE** | **17.4%** |
| **MAE** | **1,458,257,773원 (약 14.6억)** |
| **RMSE** | **5,831,198,749원 (약 58.3억)** |
| **R²** | **0.9604** |

R²=0.9604은 모델이 실제 매출 분산의 96%를 설명하고 있음을 의미한다.
...
R²=0.9604으로 GRU 모델이 2024년 마포구 매출 분산의 96% 이상을 설명하고 있다.
전체 MAPE 17.4%는 외식 업종 매출 예측에서 허용 가능한 수준이다.
(외식 업종은 날씨, 이벤트 등 비정형 요인의 영향이 크므로 10~20% 오차는 통상적)
